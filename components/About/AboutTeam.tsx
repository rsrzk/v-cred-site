        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="mb-9">
              ...
              <a href="https://www.linkedin.com/in/may-law" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">LinkedIn</a>
            </div>
            ...
            <div className="mb-9">
              ...
              <a href="https://www.linkedin.com/in/raisrazak" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">LinkedIn</a>
            </div>          
          </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <div className="mb-9">
              ...
              <a href="https://www.linkedin.com/in/nianweitan" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">LinkedIn</a>
            </div>
            ...
            <div className="mb-9">
              ...
              <a href="https://www.linkedin.com/in/zulhilmiismail" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">LinkedIn</a>
            </div>          
          </div>
        </div>
      </div>
