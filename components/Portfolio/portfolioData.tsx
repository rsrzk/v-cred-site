...
const portfolioData: Portfolio[] = [
  {
    ...
    title: "Alternative credit checks",
    paragraph:
      "Credit risk assessment of small and medium-sized enterprises (SMEs) by incorporating alternative data, machine learning and real-time information for embedded financing and trade credit applications.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Rosary - NLP for legal due dilidence",
    paragraph:
      "Information extraction from legal documents for due dilligence applications in the legal industry.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "BI for SMEs",
    paragraph:
      "Custom interactive analytics dashboards for small and medium-sized enterprises (SMEs) to gain insights from their data.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Pythia - Web scraping news channels",
    paragraph:
      "Web scraping data and articles from news channles for trend analysis and market research.",
  },
];
